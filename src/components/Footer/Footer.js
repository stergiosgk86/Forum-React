...
const Footer = () => {
  return (
    <div className="page-footer text-white">
        ...
        <div className="row mt-3">
          <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <p>
              ...
              facilis quae, id atque reiciendis distinctio, repellendus dolore
              ratione consequatur eum itaque quos ducimus animi harum, quidem
              iusto placeat a maxime! Lorem ipsum dolor sit amet,consectetur
              adipisicing elit.
            </p>
          </div>
          ...
          <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            ...
            <hr className="underline mb-4 mt-0 d-inline-block mx-auto" />
            <p>
              <i className="fas fa-home mr-3"></i> Athens, ATH 15344, GR
            </p>
            <p>
              <i className="fas fa-envelope mr-3"></i> Devills@gmail.com
            </p>
            <p>
      ...
      <div className="footer-copyright footer-bottom text-center py-3">
